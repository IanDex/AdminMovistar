			...
			<div class="card">
				<div class="card-body">
					...
					<div class="row" style="padding:20px">
						...
						<div class="col-2">
							<button id="btn_fecha" class="btn btn-secondary btn--icon"><i class="zmdi zmdi-arrow-forward"></i></button>
						...
						<div class="dropdown-demo">
                                <div class="dropdown">
                                    <button class="btn btn-light" data-toggle="dropdown">Default (Left)</button>
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="#" class="dropdown-item" onclick="exportarMovistarPlay($('#fechaInicio').val(), $('#fechaFin').val(), 3);">Generar Reporte Total</a>
                                    </div>
                                </div>
                            </div>
						
							<button class="btn btn-primary btn--icon" data-toggle="tooltip" data-placement="left" data-original-title="Exportar Excel." onclick="exportarExcelXLSX($('#fechaInicio').val(), $('#fechaFin').val());"><i class="zmdi zmdi-file-text"></i></button>
							<button class="btn btn-warning btn--icon" data-toggle="tooltip" data-placement="left" data-original-title="Exportar Excel." onclick="exportarMovistarPlay($('#fechaInicio').val(), $('#fechaFin').val(), 1);"><i class="zmdi zmdi-file-text"></i></button>
							<button class="btn btn-success btn--icon" data-toggle="tooltip" data-placement="left" data-original-title="Exportar Excel." onclick="exportarMovistarPlay($('#fechaInicio').val(), $('#fechaFin').val(), 2);"><i class="zmdi zmdi-file-text"></i></button>
						</div>
					</div>
