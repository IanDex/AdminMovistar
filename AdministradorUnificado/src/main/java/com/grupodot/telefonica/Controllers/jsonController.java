...
public class jsonController {
	...
	public jsonController(String dbName, String tableName, String headers){
		try {
			this.dbName = dbName;
	...
	public jsonController(String dbName, String tableName, String headers, String filtroTable){
		try {
			this.dbName = dbName;
			this.tableName = tableName;
			this.con = dataSource.getConnection(dbName);
	...
	public jsonController(String instance, String dbName, String tableName, String username, String password, String headers){
		try {
			this.dbName = dbName;
			this.tableName = tableName;
			if(headers.equalsIgnoreCase("")) {
